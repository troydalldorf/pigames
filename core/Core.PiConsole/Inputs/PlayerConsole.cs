...
using Core.Inputs;
using Attiny8X7SeeSaw = Core.PiConsole.Inputs.Seesaw.Attiny8X7SeeSaw;
...
public class PlayerConsole : IDisposable, IPlayerConsole
{
    ...
    private readonly Attiny8X7SeeSaw buttonsSeesaw;
    ...
    public PlayerConsole(int joystickAddress, int buttonsAddress, ConsoleOptions? options = null)
    {
        ...
        var buttonsDevice = I2cDevice.Create(new I2cConnectionSettings(BusId, buttonsAddress));
