...
namespace Core.Inputs.Seesaw
{
    public partial class Attiny8X7SeeSaw : IDisposable
    {
        ...
        public void SetGpioPinModeBulk(ulong pins, PinMode mode)
        {
            ...
            {
                case PinMode.Output:
                    Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioDirsetBulk, pinArray);
                    break;

                case PinMode.Input:
                    Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioDirclrBulk, pinArray);
                    break;

                case PinMode.InputPullUp:
                    Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioDirclrBulk, pinArray);
                    Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioPullenset, pinArray);
                    Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioBulkSet, pinArray);
                    break;

                case PinMode.InputPullDown:
                    Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioDirclrBulk, pinArray);
                    Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioPullenset, pinArray);
                    Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioBulkClr, pinArray);
                    break;
            }
        }
        ...
        public void WriteGpioDigitalBulk(ulong pins, bool value)
        {
            ...
            Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, value ? SeesawFunction.GpioBulkSet : SeesawFunction.GpioBulkClr, PinsToPinArray(pins));
        }
        ...
        public ulong ReadGpioDigitalBulk(ulong pins)
        {
            ...
            return PinArrayToPins(Read(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioBulk, 8)); // & pins;
        }
        ...
        public void SetGpioInterrupts(uint pins, bool enable)
        {
            ...
            Write(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, enable ? SeesawFunction.GpioIntenset : SeesawFunction.GpioIntenclr, buffer);
        }
        ...
        public uint ReadGpioInterruptFlags()
        {
            ...
            return BinaryPrimitives.ReadUInt32BigEndian(Read(Iot.Device.Seesaw.Seesaw.SeesawModule.Gpio, SeesawFunction.GpioIntflag, 4));
        }
